...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--layer", dest="layer", action="append", default="7", help="Target layer for activation capture")
    parser.add_argument("--batch-size", type=int, default=4)
    parser.add_argument("--device", default="cuda" if torch.cuda.is_available() else "cpu")
    parser.add_argument("--projection", choices=["pca", "tsne", "umap"], default="pca", help="Projection method")
    parser.add_argument("--output", type=Path, default=Path("/data/xiangtao/projects/crossdefense/code/analysis_results/03-conflict/Llama-3.2-1B-Instruct-tofu"), help="Output directory")
