...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--base-model", default="/data/xiangtao/projects/crossdefense/code/defense/privacy/open-unlearning/saves/unlearn/Llama-3.2-1B-Instruct-tofu/Llama-3.2-1B-Instruct-tofu-NPO", help="Path to M_tofu (base model)") 
    parser.add_argument("--defense-model", default="/data/xiangtao/projects/crossdefense/code/defense/safety/DPO/DPO_models/different/Llama-3.2-1B-Instruct-tofu-NPO-DPO", help="Path to the defense model") 
    ...
    parser.add_argument("--output", default="/data/xiangtao/projects/crossdefense/code/analysis_results/0-key_layers/Llama-3.2-1B-Instruct-tofu-NPO-DPO/result.json", type=Path, help="Output JSON file for metrics")
    ...
    parser.add_argument(
        "--plot-path",
        type=Path,
        default="/data/xiangtao/projects/crossdefense/code/analysis_results/0-key_layers/Llama-3.2-1B-Instruct-tofu-NPO-DPO/result.png",
